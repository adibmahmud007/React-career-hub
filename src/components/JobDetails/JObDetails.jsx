    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="md:grid md:gap-4 md:grid-cols-4 md:text-xl text ">
                <div className="md:col-span-3 text-justify px-4">
                ...
                <div className="md:col-span-1 bg-slate-200 text-black rounded-xl p-4 m-3">
                    ...
                    <div className="">
                        ...
                        <div className="text-center">
                            <button onClick={handleApplyJob} className="button w-full">Apply Now</button>
                        </div>
                    </div>
                </div>
            </div>
